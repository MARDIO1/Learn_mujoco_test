...
### 1.1. 升力 (Lift, $L$)
$L = \frac{1}{2} \rho V^2 S_{ref} C'_{L_\alpha} \alpha + \dots$ (其他项同理)

### 1.2. 阻力 (Drag, $D$)
$D = \frac{1}{2} \rho V^2 S_{ref} C'_{D_\alpha} \alpha + \dots$

### 1.3. 侧向力 (Side Force, $Y$)
$Y = \frac{1}{2} \rho V^2 S_{ref} C'_{Y_\alpha} \alpha + \dots$

## 2. 空气动力矩 (Aerodynamic Moments)

### 2.1. 俯仰力矩 (Pitching Moment, $M$)
$M = \frac{1}{2} \rho V^2 S_{ref} L_{ref} C'_{m_\alpha} \alpha + \dots$

### 2.2. 滚转力矩 (Rolling Moment, $L$)
$L = \frac{1}{2} \rho V^2 S_{ref} L_{ref} C'_{l_\alpha} \alpha + \dots$

### 2.3. 偏航力矩 (Yawing Moment, $N$)
$N = \frac{1}{2} \rho V^2 S_{ref} L_{ref} C'_{n_\alpha} \alpha + \dots$
